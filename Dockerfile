...
RUN \
  wget -O /tmp/firefox.tar.bz2 https://download-installer.cdn.mozilla.net/pub/firefox/releases/105.0.2/linux-x86_64/en-US/firefox-105.0.2.tar.bz2 && \
  cd /opt && \
...
RUN \
  ...
  apt update && \
  apteryx 1password='8.9.6~30.BETA'
RUN \
